...
if ($ok) {
    require('inc/db.php');
    $sql = "INSERT INTO projects (preview, previewAlt, projectTitle, projectDescription, gitHubLink, projectLink) 
    VALUES (:preview, :previewAlt, :projectTitle, :projectDescription, :gitHubLink, :projectLink)";
